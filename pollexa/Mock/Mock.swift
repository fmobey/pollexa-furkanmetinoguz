...
class MockService {
    func fetchPolls(completion: @escaping ([Poll]) -> Void) {
        let polls = [
            ...
            Poll(avatarImageName: "User3", userName: "Lisa Bryant", lastTime: "3h ago", lastVotedTime: "2h ago", contentMessage: " am in the middle of these two perfumes. Which one should I buy?", firstLikeImageName: "Option1", secondLikeImageName: "Option2", totalVotes: 200),            Poll(avatarImageName: "User2", userName: "John Smith", lastTime: "2h ago", lastVotedTime: "1h ago", contentMessage: "Which way would you choose for your next vacation?", firstLikeImageName: "Option3", secondLikeImageName: "Option4", totalVotes: 150),
            Poll(avatarImageName: "User3", userName: "Lisa Bryant", lastTime: "3h ago", lastVotedTime: "2h ago", contentMessage: " am in the middle of these two perfumes. Which one should I buy?", firstLikeImageName: "Option1", secondLikeImageName: "Option2", totalVotes: 200),            Poll(avatarImageName: "User2", userName: "John Smith", lastTime: "2h ago", lastVotedTime: "1h ago", contentMessage: "Which way would you choose for your next vacation?", firstLikeImageName: "Option3", secondLikeImageName: "Option4", totalVotes: 150),
